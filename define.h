...
#define MEASURE_HANKEI_D	( 0.19 )//( 190.0 )	// 二つ平行についているエンコーダとロボットの中心の距離
#define MEASURE_HANKEI_L	( 0.2495 )//( 249.5 )	// 上のエンコーダに対して垂直についているエンコーダとロボットの中心の距離
...
#define MECANUM_HANKEI_D	(0.0)
#define MECANUM_HANKEI_L	(0.0)